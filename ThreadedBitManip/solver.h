...
inline int removeTopPileCard(GameState* state, int column) {
    ...
    state->piles[column] = (state->piles[column] >> 4) | (0x0F << (4 * 7));
    return card;
}
